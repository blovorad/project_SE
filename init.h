 ...
 * \brief fichier entete qui regroupe les fonctions/defines/structures utiles a l'initialisation de la SDL et de tous les composants necessaires au fonctionnement du programme
 */
 ...
 * \author Gautier Levesque
 * \brief nettoyage de toutes les ressources allouees dynamiquement par la SDL et pour le programme
 * \param window window et renderer a detruire
 * \param graphics le tableau de textures a detruire
 * \param histogramme les textes de l'histogramme a detruire
 */
