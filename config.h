 ...
 * \param file fichier de configuration ouvert
 * \param processus_array tableau qui va être rempli avec toutes les informations des processus du test
 * \return entier 0 si ok, -1 sinon
 */
 ...
 * \author Gautier Levesque
 * \date 29/01/2022
 * \brief selection de l'algorithme d'ordonanncement par comparaison de chaine de caractère
